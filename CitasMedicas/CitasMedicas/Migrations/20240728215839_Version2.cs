        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NombreConsultorio = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DescripcionConsultorio = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CedulaPaciente = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    TelefonoPaciente = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CedulaMedico = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    NombreMedico = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ApellidoMedico = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CorreoMedico = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TelefonoMedico = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FechaNacimientoMedico = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UsuarioId = table.Column<string>(type: "nvarchar(450)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedicoEspecialidad", x => new { x.EspecialidadId, x.MedicoId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DescripcionAntecedente = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Citas_HistoriasClinicas_HistoriaClinicaId",
                        column: x => x.HistoriaClinicaId,
                        principalTable: "HistoriasClinicas",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MedicamentoReceta_Citas_CitaId",
                        column: x => x.CitaId,
                        principalTable: "Citas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MedicamentoReceta_Medicamentos_MedicamentoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicamentoReceta_CitaId",
                table: "MedicamentoReceta",
                column: "CitaId");

            migrationBuilder.CreateIndex(
                name: "IX_MedicamentoReceta_MedicamentoId",
                table: "MedicamentoReceta",
